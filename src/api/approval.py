"""Approval API — endpoint for signaling human approval to waiting workflows.

Sends the ``approve_publish`` Temporal signal to a pipeline workflow that is
in the ``AWAITING_APPROVAL`` state.

Architecture reference: Epic 21, Story 5
"""
