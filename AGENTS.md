...
For any frontend work (HTML templates, HTMX fragments, React components, CSS/Tailwind classes), use:

- `docs/design/07-THESTUDIO-UI-UX-STYLE-GUIDE.md`

Rules:

1. Treat this document as canonical for UI/UX patterns.
2. Apply it across all frontend surfaces (`/admin/ui/*` and `/dashboard/*`) with surface-specific shell differences.
3. If introducing a new reusable UI pattern, update the style guide in the same change.
4. If another file conflicts with the style guide, follow the style guide.
