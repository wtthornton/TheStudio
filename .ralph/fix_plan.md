...
- [ ] 45.1: `npm install react-tooltip react-markdown fuse.js`. Create `HelpPanel.tsx` — slide-in/out, close button, Escape handler. **Files:** modify package.json; create frontend/src/components/help/HelpPanel.tsx.
