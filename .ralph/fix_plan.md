...
- [ ] F-0.1: Scaffold `frontend/` with Vite + React 19 + TypeScript strict + Zustand 5 + Tailwind CSS v4. Vite proxy `/api/*` to localhost:8000. Pipeline stage colors in `src/lib/constants.ts`. Test: `npm run build` < 50KB gzipped, `npm run typecheck` passes.
